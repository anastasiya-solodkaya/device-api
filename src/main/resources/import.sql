...
insert into model(brand_id, name, descriptive_name) select id, 'nexus6', 'Motorolla Nexus 6' from brand where name='motorolla';
insert into model(brand_id, name, descriptive_name) select id, 'nexus5x', 'LG Nexus 5X' from brand where name='lg';
insert into model(brand_id, name, descriptive_name) select id, 'honor7x', 'Hawei Honor 7X' from brand where name='huawei';
insert into model(brand_id, name, descriptive_name) select id, 'iphoneX', 'Apple iPhone X' from brand where name='apple';
insert into model(brand_id, name, descriptive_name) select id, 'iphone8', 'Apple iPhone 8' from brand where name='apple';
insert into model(brand_id, name, descriptive_name) select id, 'iphone4s', 'Apple iPhone 4s' from brand where name='apple';
