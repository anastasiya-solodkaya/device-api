...
insert into model(brand_id, name, descriptive_name) select id, 'galaxy s7', 'Samsung Galaxy S7' from brand where name='samsung';
insert into model(brand_id, name, descriptive_name) select id, 'galaxy s8', 'Samsung Galaxy S8' from brand where name='samsung';
insert into model(brand_id, name, descriptive_name) select id, 'galaxy s9', 'Samsung Galaxy S9' from brand where name='samsung';
